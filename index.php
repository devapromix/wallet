...
<html lang="en">
    ...
    <body>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="index.php">Домівка</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">Доставка та оплата</a></li>
                        <li class="nav-item"><a class="nav-link" href="faq.php">Питання та відповіді</a></li>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Крамниця фігурок</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Тільки ручна робота</p>
                </div>
            </div>
        </header>
        <!-- Section-->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        ...
                        $p .= '<div class="card-body p-4">';
                            ...
                            $p .= '<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">';
								...
								if ($_SESSION['cart'][pathinfo($filename, PATHINFO_FILENAME)] > 0) {
									$p .= '<a class="btn btn-outline-dark mt-auto" href="cart.php">Вже в кошику</a>';									
								} else {
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">В кошик</a></div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Apromix 2021</p></div>
        </footer>
        <!-- Bootstrap core JS-->
